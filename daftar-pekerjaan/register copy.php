        ...
        <div class="row justify-content-center">
            <div class="col-sm bg-dark text-light rounded ">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-1 form-group row">
                        <div class="col g-1">
                            <input type="number" class="form-control" placeholder="NO HP/WA" aria-label="First name">
                        </div>
                        <div class="col g-1">
                            <input type="number" class="form-control" placeholder="N I K" aria-label="Last name">
                        </div>
                    </div>
                    <div class="mb-1 form-group row">
